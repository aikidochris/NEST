...
export async function GET(request: NextRequest): Promise<Response> {
    try {
        ...
        if (propertyId) {
            ...
            // NOTE: Server-side mock enrichment removed (WS1 Data Honesty).
            // Properties return only real data from Supabase.
            // Future enrichment (hero images, owner info, facts) must come from
            // real database fields \u2014 not hardcoded server-side fixtures.
